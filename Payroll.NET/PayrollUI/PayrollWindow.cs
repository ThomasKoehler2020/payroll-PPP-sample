...
namespace PayrollUI
{
    public class PayrollWindow : Form, PayrollView
    {
        private MenuItem actionMenuItem;
        public MenuItem addEmployeeMenuItem;
        private readonly Container components = null;
        private Label employeeLabel;
        public TextBox employeesTextBox;
        private Label label1;
        private MainMenu mainMenu1;
        public Button runButton;
        public TextBox transactionsTextBox;
        ...
        public PayrollPresenter Presenter { get; set; }
